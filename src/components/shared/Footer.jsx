      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm">© Kumar Tanay. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            {/* <a href="https://facebook.com" className="hover:text-gray-400" aria-label="Github">
              ...
              <a
                  href="https://github.com/krtanay7"
                  target="_blank"
                ...
                >
                  ...
                  >
                    <path
                      ...
                      0 .268.18.58.688.482A10.025 10.025 0 0022 12.017C22 6.484 17.522 2 12 2z"
                      clipRule="evenodd"
                    />
                  </svg>
                </a>

            <a href="https://x.com/KrTanay007" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.linkedin.com/in/kumar-tanay97/" className="hover:text-gray-400" aria-label="LinkedIn">
